...
Given I no longer have access to the course's database by the time of this writing, 
the following samples are based on the project's requirements document provided by the professor 
